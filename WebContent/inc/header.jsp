...
<html lang="en">
  <head>
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #662500"  >
    <div class="text-center">
        <h2><a class="navbar-brand" href="/index.jsp">시켜만주소</a></h2></div> <!-- 최상위 인데스 jsp 호출 -->
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
           ...
           <ul class = "navbar-nav">
          	...
          	<li class = "nav-item">
          		<a class="nav-link" href="/member/logout.jsp">님 환영합니다.</a>
          	</li>
          	<li class = "nav-item">
